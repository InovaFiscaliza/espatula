            ...
            with output.empty():
                ...
                with left:
                    try:
                        ...
                        left.image(imagem, use_column_width="auto", caption=nome)
                    except Exception:
...
if STATE.mkplc is None:
    ...
    if is_folders_ok(STATE):
        config_container.text_input(
            ...
            help="Termo a ser pesquisado no site. \n Exemplos: smartphone, drone, tv-box, wifi, bluetooth, powerbank, wireless, bloqueador de sinal, jammer, transceptor, etc.",
        )
